...
export function AddLineForm({
  ...
  return (
    <div className="mb-4 rounded-2xl bg-white p-5 shadow-md dark:bg-sp-bg dark:border-2 dark:border-sp-border dark:shadow-[0_0_20px_var(--sp-glow)]">
            ...
            <button
              ...
              className={`px-3 py-1.5 text-sm ${
                mode === "fixed"
                  ...
                  : "hover:bg-gray-50 dark:hover:bg-sp-surface"
              }`}
            >
              Fixed monthly
            </button>
            ...
            {MONTH_SHORT.map((name, i) => (
              <div key={i}>
                ...
                <input
                  ...
                  step="0.01"
                  defaultValue="0"
                  className="mt-0.5 w-full rounded-md border px-2 py-1.5 text-sm dark:bg-sp-surface dark:border-sp-border"
                />
              </div>
            ))}
          </div>
