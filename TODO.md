...
- [ ] Spojiti Categories i Budget Lines u jednu stranicu — kategorije se upravljaju direktno unutar Budget Lines (dodavanje, brisanje, promena redosleda drag-and-drop ili strelicama)
- [ ] Odlučiti kako nazvati spojenu stranicu Categories + Budget Lines (npr. "Budget Plan", "Budget Structure", "Lines & Categories", "Planner"...)
